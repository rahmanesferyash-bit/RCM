...
import { checkMessage } from '../services/automodService.js';
...
export default {
  ...
  async execute(message, client) {
    try {
      ...
      // Run automod first — if the message was deleted, skip XP
      const automodHit = await checkMessage(client, message).catch(() => null);
      if (automodHit) return;
